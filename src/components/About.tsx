...
const About: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="py-12 md:py-16 relative bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <motion.div
              className="absolute top-20 left-10 w-32 h-32 bg-[#00BCD4]/10 rounded-full blur-xl"
              animate={{
                y: [-20, 20, -20],
                x: [-10, 10, -10],
              }}
            ...
            />
            <motion.div
              className="absolute bottom-20 right-10 w-24 h-24 bg-[#673AB7]/10 rounded-full blur-xl"
              animate={{
                y: [20, -20, 20],
                x: [10, -10, 10],
              }}
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">
              <span className="text-[#1A237E] font-bold">Stand Out in the Crowd</span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
            {[
              ...
              <motion.div
                ...
                className="bg-white p-4 md:p-6 rounded-lg border border-gray-200 text-center hover:border-[#00BCD4] transition-all duration-300 group shadow-lg hover:shadow-xl"
              ...
              >
                ...
                >
                  <stat.icon className="w-6 h-6 mx-auto text-[#00BCD4] group-hover:text-[#00E5FF] transition-colors" />
                </motion.div>
                <div className="text-2xl md:text-3xl font-bold text-[#00BCD4] mb-2">
      ...
      {/* About Us Section */}
      <section id="about" className="py-12 md:py-16 relative bg-gray-50 dot-grid">
        <div className="container mx-auto px-4">
          ...
          <div className="absolute inset-0 overflow-hidden opacity-20">
            <motion.div
              ...
              style={{
                backgroundImage: 'radial-gradient(circle, rgba(0, 188, 212, 0.3) 1px, transparent 1px)',
          ...
          >
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">
                <span className="text-[#1A237E] font-bold">Powering Brands with Stories and Security</span>
              </h2>
              <p className="text-sm md:text-base text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-12">
              <motion.div
                ...
                className="bg-white p-6 md:p-8 rounded-lg border border-gray-200 hover:border-[#00BCD4] transition-all duration-300 group shadow-lg hover:shadow-xl"
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <Shield className="w-8 h-8 text-[#00BCD4] group-hover:text-[#00E5FF] transition-colors" />
                </motion.div>
                <h4 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-[#1A237E]">Network Solutions</h4>
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <Zap className="w-8 h-8 text-[#00BCD4] group-hover:text-[#00E5FF] transition-colors" />
                </motion.div>
                <h4 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-[#1A237E]">Digital Content</h4>
                <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            >
              <motion.div
                ...
                className="inline-block mb-4"
              >
                <div className="w-12 h-12 mx-auto bg-gradient-to-r from-[#673AB7] to-[#2196F3] rounded-full flex items-center justify-center">
                  <Zap className="w-6 h-6 text-white" />
                </div>
              </motion.div>
              <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6">
                <span className="text-[#1A237E] font-bold">Why Pix2Pixel?</span>
              </h3>
              <p className="text-sm md:text-base text-gray-600 max-w-4xl mx-auto leading-relaxed">
